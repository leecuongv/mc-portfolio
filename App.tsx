...
const App: React.FC = () => {
  const services = [
    {
      icon: <Mic className="w-12 h-12 text-[#F0C746]" />,
    ...
    {
      icon: <Users className="w-12 h-12 text-[#F0C746]" />,
    ...
    {
      icon: <MapPin className="w-12 h-12 text-[#F0C746]" />,
    ...
    {
      icon: <Camera className="w-12 h-12 text-[#F0C746]" />,
      title: "Reviewer & KOL",
    ...
    <div className="bg-[#141414] text-white min-h-screen">
      ...
      <main>
        ...
        <section id="gallery" className="py-20 md:py-32 bg-[#202020]">
          <div className="container mx-auto px-6 lg:px-8">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold font-display text-gold-metallic">Khoảnh Khắc Ấn Tượng</h2>
          ...
          <div className="container mx-auto px-6 lg:px-8 text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-12">
              <div className="text-xl space-y-4">
                ...
                <p><strong>Email:</strong> <a href="mailto:contact@hoaithuong.com" className="hover:text-[#F0C746]">contact@hoaithuong.com</a></p>
