...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative h-screen flex items-center justify-center text-center">
      ...
      <img src="./data/avt.png" alt="Background" className="absolute inset-0 w-full h-full object-cover z-[-1]" />
      <div className="relative z-10 p-4">
        <div className="relative inline-block p-1 rounded-full bg-gradient-to-br from-[#f0e68c] via-[#d4af37] to-[#b8860b] mb-6 shadow-lg">
            <img src="./data/avt.png" alt="MC Hoài Thương" className="rounded-full w-40 h-40 md:w-48 md:h-48 object-cover" />
        </div>
